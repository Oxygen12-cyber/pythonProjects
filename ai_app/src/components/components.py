...
class MenuIcon(ft.Container):
    def __init__(self, iconsrc, iconsize, label: str = None, labelsize: str = 14):
        ...
        self.content = ft.Column(
            [
                ft.Container(
                    ft.Image(src=self.iconsrc, fit=ft.ImageFit.COVER),
                    width=iconsize,
                    height=iconsize,
                ),
                ft.Container(
                    ft.Text(
                        ...
                        style=ft.TextStyle(
                            color="white", size=labelsize, weight=ft.FontWeight.BOLD
                        ),
                    )
                ),
            ],
...
box = ft.TextField(
    ...
    hint_style=ft.TextStyle(
        color=ft.Colors.BLACK38, size=18, weight=ft.FontWeight.W_500
    ),
    width=500,
    height=80,
    multiline=True,
...
send = ft.GestureDetector(
    ft.Container(
        ft.Image(src="src/assets/icons/send_ico.png", fit=ft.ImageFit.COVER),
        width=40,
        height=40,
    ),
    on_tap=onsubmit,
        ...
        [
            ft.Container(
                ...
                border=ft.border.all(
                    4, color=ft.Colors.with_opacity(0.4, "#ED759F")),
...
menu_bar = ft.Container(
    ...
    content=ft.Column(
        [
            MenuIcon(
                iconsrc="src/assets/icons/home_ico.png",
                iconsize=48,
                label="Chat",
                labelsize=16,
            ),
            MenuIcon(
                iconsrc="src/assets/icons/plus_ico.png",
                iconsize=48,
                label="New",
                labelsize=16,
            ),
            MenuIcon(
                iconsrc="src/assets/icons/folder_ico.png",
                iconsize=48,
                label="Recent",
                labelsize=16,
            ),
            MenuIcon(
                iconsrc="src/assets/icons/gear_ico.png",
                iconsize=48,
                label="Settings",
                labelsize=16,
            ),
    ...
    content=ft.Stack(
        [
            ft.Container(
                expand=True,
                bgcolor="transparent",
                padding=ft.padding.only(top=12, bottom=60, left=12, right=12),
                content=chat_area,
                height=900,
            ),
            field,
        ...
        [
            ...
            ft.Row(
                [
                    ft.Container(
                        ft.Image(
                            src="src/assets/icons/dots_ico.png", fit=ft.ImageFit.COVER
                        ),
                        width=30,
                        height=10,
                    ...
                    ft.Container(
                        ft.Image(
                            src="src/assets/icons/profile_ico.png",
...
app_body = ft.Container(expand=8, content=ft.Row([menu_bar, chat_block]))
